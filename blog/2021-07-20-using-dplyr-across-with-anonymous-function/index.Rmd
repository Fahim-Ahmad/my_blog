...
In my previous [post](https://fahimahmad.netlify.app/posts/advantages-of-dplyracross-to-apply-a-function-across-multiple-columns/), I briefly described the advantages of using `across()` while applying the same function over multiple columns. In this post, I provide an overview of using `across()` with the anonymous function.
